...
import { useSocialSignIn } from "@/features/auth/api/use-sign-in";
import { useEmailSignUp } from "@/features/auth/api/use-sign-up";
...
export const SignUpForm = () => {
  ...
  const isPending =
    emailSignUpMutation.isPending || socialSignInMutation.isPending;
